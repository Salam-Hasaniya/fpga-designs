...
# use two signals (for top and bottom rows) to maintain pin#
#====================================================================================================
set_property -dict {PACKAGE_PIN D14 IOSTANDARD LVCMOS33} [get_ports {pmod_cs}]
set_property -dict {PACKAGE_PIN F16 IOSTANDARD LVCMOS33} [get_ports {pmod_sck}]
set_property -dict {PACKAGE_PIN G16 IOSTANDARD LVCMOS33} [get_ports {pmod_miso}]
